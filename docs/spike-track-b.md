...
- [ ] Path B hear: **parked on IONOS.** 2026-09-19 09:25Z recheck `ses_ionos_udpcheck_092538`: Windows TCP 8445 + UDP 49152–65279 open; Teams `52.112.22.192` ESTABLISHED; still **500#1203002**. Azure IaaS out of homelab budget. **Path C** (companion WASAPI ear + Path A playPrompt) — `docs/path-c-companion-ear.md`. **Do not** flip `plane=auto`.
